...
@interface SSXHViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation SSXHViewController
-(void)getData{
